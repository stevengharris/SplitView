...
public struct Split<S: View, D: View>: ViewModifier {
    ...
    public init(_ layout: SplitLayout, spacing: CGFloat? = nil, fraction: FractionHolder, hide: SideHolder, @ViewBuilder splitter: @escaping (()->D), @ViewBuilder secondary: @escaping (()->S)) {
        self.layout = layout
